          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                (controller.dislikedlist.length == 0)
                    ? Expanded(
                      child: Center(
                          child: customText(
                            text: "List is empty",
                    ...
                    : Expanded(
                        child: ListView.separated(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        customText(
                                          text:controller.dislikedlist[idx].name.split(" ")[0],
                                          fontSize: 20,
                                          fontWeight: FontWeight.w500,
                                          color: Colors.black,
                                        ),
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        controller.deleteFromDisLiked(idx);
                                      },
                                      child: CircleAvatar(
                                        radius: 20,
                                        backgroundColor: Colors.grey[200],
                          ...
                          itemCount: controller.dislikedlist.length,
                        ),
                      )
              ],
            ),
